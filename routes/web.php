...
// Password reset flow
Route::get('/send-otp-page', [AuthController::class, 'ShowSendOTPPage'])->name('show.send.otp');
Route::post('/send-otp', [AuthController::class, 'SendOTPCode'])->name('send.otp');
Route::get('/verify-otp-page', [AuthController::class, 'ShowVerifyOTPPage'])->name('show.verify.otp');
Route::post('/verify-otp', [AuthController::class, 'VerifyOTP'])->name('verify.otp');
Route::get('/reset-password-page', [AuthController::class, 'ShowResetPasswordPage'])->name('show.reset.password');
